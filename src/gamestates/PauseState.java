...
public class PauseState extends BasicGameState implements KeyListener {
	...
	public PauseState(final int gameplaystate) throws SlickException
	    {
	    	super();
